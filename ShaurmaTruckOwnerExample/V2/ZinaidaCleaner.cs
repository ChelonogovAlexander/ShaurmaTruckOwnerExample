namespace ShaurmaTruckOwnerExample.V2
{
    /// <summary> Уборщица Зинаида </summary>
    public class ZinaidaCleaner
    {
        ...
        public void CleanCafe()
        {
            ...
            System.Console.WriteLine("Чертыхаться");
            ...
            System.Console.WriteLine("Подскользнуться и громко ругаться");
        }
    }
}